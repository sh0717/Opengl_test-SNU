...
class AModel {
public:
	vector<ATexture> textures_loaded;
	vector<AMesh> meshes;
	string directory;
...
private:
	...
	AMesh processMesh(aiMesh* mesh, const aiScene* scene)
	{
		...
		vector<ATexture> diffuseMaps = loadMaterialTextures(material, aiTextureType_DIFFUSE, "texture_diffuse");
		textures.insert(textures.end(), diffuseMaps.begin(), diffuseMaps.end());
		vector<ATexture> specularMaps = loadMaterialTextures(material, aiTextureType_SPECULAR, "texture_specular");
	...
	unsigned int TextureFromFile(const char* path, const string& directory, bool gamma = false)
	{
		...
		{
			std::cout << "Texture failed to load at path:xxx " << path << std::endl;
			stbi_image_free(data);
		}
