...
// camera
Camera camera(glm::vec3(5.81383f, 1.304f, 2.8f), glm::vec3(0.0f, 1.0f, 0.0f), -140.0f);
...
int main()
{
    ...
    std::vector<float> quad_data({
        // positions         // uvs
        1.0, 1.0, 0.0f,  1.0f, 1.0f,  // top right
    ...
    rayTracingShader.setFloat("material_ground.shininess", 80);
    ...
    rayTracingShader.setVec3("material_dielectric_glass.extinction_constant", glm::log(glm::vec3(0.80f, 0.89f, 0.85f)));
    rayTracingShader.setFloat("material_dielectric_glass.shadow_attenuation_constant", 0.7);
    ...
    while (!glfwWindowShouldClose(window))// render loop
    {
        ...
        rayTracingShader.setInt("ShadowVersion",ShadowVersion);
